...
_G.NameHub = "Dragon" -- ชื่อ Hub
_G.Title = "Dragon Script blox fruits" -- คำอธิบาย
-----------------------------------------------------------------
...
local Main = Window:Tab("主要功能","14477284625")
local AutoQuest = Window:Tab("物品任务","11446859498")
local Events = Window:Tab("自动海域事件","10734941354")
local Racer = Window:Tab("竞速 V4 & 透视","10747372167")
local RaidFruit = Window:Tab("副本 & 果实","10734975692")
local Playerrss = Window:Tab("传送 & PVP","10734910680")
local MiscShop = Window:Tab("商店 & 其他","10723434557")
local AutoStatus = Window:Tab("服务器状态","10709770317")

local AutoFarm = Main:Section("自动功能","Left")
local Settings = Main:Section("精通设置","Right")

local Items = AutoQuest:Section("自动物品任务","Left")
local Dragon = AutoQuest:Section("自动龙任务","Right")

local Volcano = Events:Section("自动火山事件","Left")
local Events = Events:Section("自动活动","Right")

local Trailers = Racer:Section("自动v4","Left")
local Espbruh = Racer:Section("透视玩家","Right")

local AutoRaid = RaidFruit:Section("自动副本果实","Left")
local Autofruit = RaidFruit:Section("自动随机果实","Right")

local Teleport = Playerrss:Section("传送岛屿","Left")
local Playersss = Playerrss:Section("玩家战斗","Right")

local TikTokShop = MiscShop:Section("商店功能","Left")
local AutoMisc = MiscShop:Section("自动其他","Right")

local Status = AutoStatus:Section("状态数值","Left")
local StatusTime = AutoStatus:Section("游戏时间","Right")

AutoFarm:Toggle("自动升级",false,function(value)
    _G.AutoFarm = value
  ...
  AutoFarm:Toggle("自动杀死附近 |生物光环", false,function(value)
         _G.AutoNear = value
  ...
  _G.SelectWeaponType = "Melee"  -- 添加武器类型变量

AutoFarm:Dropdown("选择武器", {"Melee", "Sword", "Gun", "Fruit"}, {"Melee"}, function(v)
    _G.SelectWeaponType = v  -- 保存选择的武器类型
end)
...
task.spawn(function()
    while wait() do
        pcall(function()
            ...
            -- 根据武器类型查找
            if _G.SelectWeaponType == "Melee" then
            ...
            elseif _G.SelectWeaponType == "Sword" then
                for _, v in ipairs(weapons) do
            ...
            elseif _G.SelectWeaponType == "Gun" then
                for _, v in ipairs(weapons) do
            ...
            elseif _G.SelectWeaponType == "Fruit" then
                for _, v in ipairs(weapons) do
            ...
            if not weaponFound then
                _G.SelectWeapon = "Combat"  -- 设置一个安全的默认武器
            end
        end)
    end
end)
          
     AutoFarm:Seperator("自动精通")       
     
     if World1 or World2 then
     AutoFarm:Dropdown("选择精通模式",{"刷取等级精通", "刷取等级精通（无任务）"},{"刷取等级精通（无任务）"},function(Value)
       _G.selectFruitFarm = Value
      end)
    end      
      if World3 then
    AutoFarm:Dropdown("选择精通模式",{"刷取等级精通", "刷取等级精通（无任务）","刷取骨头精通","刷取蛋糕精通"},{"刷取等级精通（无任务）"},function(Value)
       _G.selectFruitFarm = Value
      end)
    end      

      AutoFarm:Toggle("自动刷取果实精通", false,function(value)
...
spawn(function()
    while wait() do
      ...
      AutoFarm:Seperator("自动宝箱")       
         
       AutoFarm:Toggle("自动宝箱", false,function(value)
         _G.FarmChest = value 
	...
	while wait() do
      ...
      AutoFarm:Seperator("自动收集浆果")       
       
    AutoFarm:Toggle("自动浆果", false,function(value)
...
spawn(function()
   ...
   if World3 then
       AutoFarm:Seperator("自动骨头")
                
    Boneyou = AutoFarm:Label("查看骨头的数量")
                
    spawn(function()
        while wait() do
            pcall(function()
                Boneyou:Set("当前骨头 : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
            end)
        end
    end)
     
     AutoFarm:Toggle("自动刷骨头", false,function(value)
         game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
     		_G.FarmBone = value 
    ...
    spawn(function()
        ...
        AutoFarm:Toggle("神圣镰刀", false,function(value)         
     	_G.Hallow = value 
         StopTween(_G.Hallow)
       end)
    ...
    while wait() do
      ...
      AutoFarm:Toggle("自动交易骨头", false,function(value)         
     		_G.Rdbone = value 
       end)
       ...
       spawn(function()
         ...
         AutoFarm:Toggle("自动祈祷", false,function(value)         
     		_G.Pray = value 
       end)
       ...
       spawn(function()
        ...
        AutoFarm:Toggle("自动尝试运气", false,function(value)         
     		_G.Trylux = value 
       end)
       ...
       AutoFarm:Seperator("天空暴君功能")
              
       AutoFarm:Toggle("自动刷天空暴君", false,function(value)         
     	_G.FarmDaiBan = value 
    ...
    while task.wait() do
        ...
        AutoFarm:Seperator("蛋糕王子功能")

   CakePrinceStatus = AutoFarm:Label("查看蛋糕王子状态")
    task.spawn(function()
       while task.wait() do
          pcall(function()
           if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
           CakePrinceStatus:Set("已击杀 : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41)..' / 500')
          elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
          CakePrinceStatus:Set("已击杀 : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40)..' / 500')
           elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
        CakePrinceStatus:Set("已击杀 : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39)..' / 500')
        else
      CakePrinceStatus:Set("蛋糕王子已刷新")
      end
    end)
  end
  end)
 
       AutoFarm:Toggle("自动刷蛋糕王子任务", false,function(value)         
     	_G.FarmCake = value 
   ...
   local CakePos = CFrame.new(-2130.80712890625, 69.95634460449219, -12327.83984375)
    ...
    while task.wait() do
       ...
       AutoFarm:Toggle("自动蛋糕王子 v2", false,function(value)         
   ...
   spawn(function()
	...
	AutoFarm:Toggle("自动开启任务", false,function(value)         
     ...
     if World1 then
       _G.SelectBoss = "猩猩王"
       AutoFarm:Dropdown("选择Boos", {"电锯", "猩猩王", "波比", "雪怪", "暴徒首领", "海军中将", "典狱长", "总典狱长", "天鹅", "岩浆海军上将", "鱼人领主", "威斯珀", "雷神", "赛博格", "剑术大师"}, {"猩猩王"},function(Value)
        _G.SelectBoss = Value
       end)
   	  elseif World2 then      
       _G.SelectBoss = "钻石"
       AutoFarm:Dropdown("选择Boss", {"钻石", "杰里米", "法吉塔", "唐·斯旺", "烟雾海军上将", "诅咒船长", "黑胡子", "秩序", "觉醒冰海军上将", "潮汐守护者"}, {"钻石"}, function(Value)
       _G.SelectBoss = Value
      end)      
     elseif World3 then      
       _G.SelectBoss = "石巨人"
       AutoFarm:Dropdown("选择Boss", {"石巨人", "岛女皇", "火箭海军上将", "象主船长", "美海盗", "真·因陀罗", "龙马", "噬魂者", "蛋糕女王", "卡塔库栗", "面团王"}, {"石巨人"}, function(Value)
        _G.SelectBoss = Value
       end)      
    end     
    
       AutoFarm:Seperator("自动击杀Boos")
      
    BossSpawn = AutoFarm:Label("Boos状态检测")
    ...
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss) or game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss) then
                BossSpawn:Set("状态: Boss已刷新 ✅")
            else
                BossSpawn:Set("状态: Boss未刷新 ❌")
               end
            end)
          end
       end)
 
    AutoFarm:Toggle("自动击杀boos", false,function(value)         
      	_G.AutoBoss = value 
      ...
      AutoFarm:Seperator("自动刷材料")
      
      if World1 then
      AutoFarm:Dropdown("选择材料", {"皮革+废铁", "鱼尾", "岩浆矿", "天使之羽"}, {"鱼尾"}, function(Value)
   ...
   spawn(function()
     ...
     if World2 then
      AutoFarm:Dropdown("选择材料",{"皮革+废铁","放射性物质","岩浆矿","吸血鬼獠牙","神秘水滴","灵质",},{"皮革+废铁"},function(Value)
        _G.SelectMaterial = Value
      end)
   ...
   spawn(function()
      ...
      if World3 then
      AutoFarm:Dropdown("选择材料",{"皮革+废铁","鱼尾","迷你獠牙","龙鳞","魔法可可"},{"鱼尾"},function(Value)
        _G.SelectMaterial = Value
      end)
   ...
   spawn(function()
    ...
    spawn(function()
      ...
      AutoFarm:Toggle("自动刷材料", false,function(Value)
 ...
 ---------------------------- Auto Settings 
      ...
      KillPercent = "30"
       Settings:Dropdown("选择目标血量阈值", {"20%", "25%", "30%", "35%", "40%", "45%", "50%", "55%", "60%", "65%", "70%", "75%", "80%"}, "25%", function(Value)
        KillPercent = Value
      end)
      
     Settings:Toggle("自动使用Z技能",true,function(Z)
       SkillZ = Z
     end)
     
     Settings:Toggle("自动使用X技能",false,function(X)
       SkillX = X
     end)          
       
     Settings:Toggle("自动使用C技能",false,function(C)
       SkillC = C
     end)      
     
     Settings:Toggle("自动使用V技能",false,function(V)
       SkillV = V
     end)      
     
     Settings:Toggle("自动使用F技能",false,function(F)
       SkillC = F
     end)  
     
     Settings:Seperator("自动功能设置")         
     
      
    Settings:Toggle("自动聚集怪物", true,function(value)
...
PosY = 35            
  ...
  Settings:Toggle("水上行走", true,function(value)      
      _G.WalkWater = value
 end)
    ...
    spawn(function()
      ...
      Settings:Toggle("自动设置重生地点", false,function(value)      
      _G.CheckPoint = Value
     end)
    spawn(function()
    	while wait() do
  ...
  Settings:Toggle("自动霸气", true,function(value)
      _G.AutoHaki = value
     end)
     spawn(function()
    while task.wait(0.1) do
     ...
     Settings:Toggle("自动激活v3", false,function(value)    
      _G.AutoRaceV3 = value
    end)
  spawn(function()
    while wait() do
   ...
   Settings:Toggle("自动激活v4", false,function(value)    
      _G.AutoRaceV4 = value
    end)
    spawn(function()
    while wait() do
  ...
  Settings:Toggle("无限闪避", false,function(Soru)       
      InfiniteSoru = Soru
     end)
    ...
    Settings:Toggle("旋转位置", false,function(value)       
      _G.SpinPos = Value 
     end)
     
PosY = 35
  Settings:Dropdown("距离",{"20","25","30","35","40","45","50","55","60","65","70","75","80"},{"50"},function(Value)
        PosY = value
      end)
  
  Settings:Toggle("闪避无冷却", false,function(value)       
    ...
    spawn(function()
     ...
     Settings:Toggle("无限月步", false,function(Geppo)       
         InfiniteGeppo = Geppo
        end)
        spawn(function()
    while task.wait(1) do
    ...
    Settings:Toggle("无限跳跃", false,function(Cokka)       
     Infinite = Cokka
     ...
     if World1 or World2  then
        Items:Seperator("自动海域")
        end
       
      if World1 then
      Items:Toggle("自动二海", false,function(Second)   
      ...
      if World2 then
      Items:Toggle("自动接取玫瑰王国任务", false,function(Bartilo)      
    ...
    pcall(function()
        ...
        Items:Toggle("自动三海", false,function(ThirdSea)      
    ...
    while wait() do
       ...
       if World2 then
       Items:Seperator("自动工厂")
       
        Items:Toggle("自动工厂", false,function(Values)      
       ...
       spawn(function()
        ...
        if World3 then
        Items:Seperator("自动海盗")
       
       Items:Toggle("自动海盗突袭", false,function(Values)      
	...
	while wait() do
     ...
     Items:Seperator("自动精英猎人")
  
    EliteHunterKill = Items:Label("查看精英猎人击杀数")
     
     spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                EliteHunterKill:Set("击杀数  : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
            else
               EliteHunterKill:Set("击杀数 : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))	
            end
        end)
         ...
         EliteHunter = Items:Label("查看精英猎人")
     
     task.spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
               EliteHunter:Set("精英猎人已刷新")
            else
                EliteHunter:Set("当前服务器无精英猎人 ❌")
            end
        end)
    end
end)
     
     Items:Toggle("自动刷精英猎人", false,function(Values)      
   ...
   Items:Seperator("自动突袭Boos")
    
    if World1 then
     Items:Toggle("自动击杀灰胡子", false,function(Values)      
          _G.Greybeard = Values
     ...
     if World2 then         
       Items:Toggle("自动击杀黑胡子", false,function(Values)
       ...
       Items:Toggle("自动击杀诅咒船长", false,function(Values)      
	...
	while wait() do
		pcall(function()
		   if game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form") or game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
		      RipIndra:Set("真·因陀罗已刷新 ✅")
		   else
		      RipIndra:Set("当前服务器无真·因陀罗 ❌")
		   end
		end)
    end
end)
      
        Items:Toggle("自动杀死真·因陀罗", false,function(Values)      
    ...
    local AdminPos = CFrame.new(-5344.822265625, 423.98541259766, -2725.0930175781)
     spawn(function()
        ...
        Items:Seperator("自动购买霸气色")
        
        Items:Toggle("自动切换霸气色", false,function(Value) 
     ...
     spawn(function()
      ...
      if World2 then
      Items:Seperator("自动购买传说剑")
      
      Items:Toggle("自动购买传说剑", false,function(Value) 
 ...
 if World3 then
       Items:Seperator("自动获取传说物品")
         
       Items:Toggle("自动获取阎魔", false,function(Values) 
          _G.AutoYama = Values
        end)
       ...
       spawn(function()
         ...
         Items:Toggle("自动获取圣火与土下座", false,function(Values) 
      ...
      Items:Toggle("自动获取土下座", false,function(Values)      
       ...
       Items:Seperator("自动获取物品")       
        if World1 then         
        SaberO = Items:Label("查看Boss Saber")
         
         task.spawn(function()
           while wait() do
            pcall(function()
            if game.ReplicatedStorage:FindFirstChild("Saber Expert") or game.Workspace.Enemies:FindFirstChild("Saber Expert") then
           SaberO:Set("Boss Saber 已刷新 ✅")
            else
           SaberO:Set("Boos Saber 没刷新 ❌")
           end
         end)
       end
     end)

       Items:Toggle("自动 Saber", false,function(Values) 
          AutoSaber = Values
          StopTween(AutoSaber)
       end)
     ...
     PoleStatus = Items:Label("查看 Boss Pole")
      
    task.spawn(function()
     while wait() do
       pcall(function()
      if game.ReplicatedStorage:FindFirstChild("Thunder God") or game.Workspace.Enemies:FindFirstChild("Thunder God") then
         PoleStatus:Set("Boos Pole 已刷新 ✅")
          else
         PoleStatus:Set("Boos Pole 没刷新 ❌")
        end
       end)
      end
    end)
    
      Items:Toggle("自动 Pole", false,function(Values)      
          _G.Autopole = Values
    ...
    Items:Toggle("自动获取电锯剑", false,function(Values)      
          _G.Autosaw = Values
     ...
     local SharkPos = CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094)
      ...
      Items:Toggle("自动获取典狱长之剑", false,function(Values)      
      ...
      Items:Toggle("自动获取三叉戟", false,function(Values)  
          _G.Trident = Values
        ...
        if World2 then
        Items:Toggle("自动获取长剑", false,function(Values)      
          _G.Longsword = Values
         ...
         Items:Toggle("自动获取重力剑", false,function(Values)      
     ...
     Items:Toggle("自动获取连枷剑", false,function(Values)      
      ...
      Items:Toggle("自动获取炼狱剑", false,function(Values)      
    ...
    Items:Toggle("自动获取龙纹三叉戟", false,function(Values)      
       ...
       if World3 then
      Items:Toggle("自动获取双钩剑", false,function(Values)      
       ...
       Items:Toggle("自动获取卡文迪什剑", false,function(Values)      
       ...
       Items:Toggle("自动获取伙伴剑", false,function(Values)      
...
spawn(function()
   ...
   _G.SelectQuestDragon = "剧毒刺客"
  Dragon:Dropdown("选择目标任务",{"剧毒刺客","九头蛇执法者"},{"剧毒刺客"},function(v)
    _G.SelectQuestDragon = v
     end)

   Dragon:Toggle("自动刷任务", false,function(Values)      
   ...
   Dragon:Toggle("自动伐木", false,function(Values)      
...
spawn(function()
 ...
 VolcanoSP = Volcano:Label("查看火山岛屿")
  
  spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                VolcanoSP:Set("火山岛屿 已刷新 ✅")
            else
                VolcanoSP:Set("火山岛屿 没刷新 ❌")
               end
            end)
          end
       end)
...
function GetLocalBoat()
    ...
    Volcano:Button("清除火山岩浆",function()
  ...
  Volcano:Toggle("自动寻找火山岛", false, function(value)
...
RunService.RenderStepped:Connect(function()
    ...
    if prehistoricIsland then
      ...
      Volcano:Toggle("自动定位火山岛区域", false, function(value)
          _G.Nocliprock = value
...
spawn(function()
  ...
  Volcano:Toggle("瞬移至火山岛", false, function(value)
  ...
  Volcano:Toggle("自动守护火山岛", false, function(value)
...
spawn(function()
  ...
  Volcano:Toggle("自动近战技能", false, function(value)
      _G.UseMelee = value
  end)
  
  Volcano:Toggle("自动剑术技能", false, function(value)
      _G.UseSword = value
  end)
  
  Volcano:Toggle("自动枪系技能", false, function(value)
      _G.UseGun = value
  end)

  Volcano:Toggle("自动击杀熔岩巨人", false, function(value)
      _G.KillGolem = value
...
Volcano:Toggle("击杀光环熔岩巨人", false, function(value)
      _G.Kill_Aura = value
  end)
...
spawn(function()
  ...
  Volcano:Toggle("自动收集骨头", false, function(Value)
...
Volcano:Toggle("自动收集蛋", false, function(Value)
    _G.CollectEgg = Value    
...
spawn(function()
    ...
    Events:Button("清除迷雾",function()
    game:GetService("Lighting").BaseAtmosphere:Destroy()
    end)

      Events:Seperator("九尾群岛")
   
  Kitsune = Events:Label("查看九尾岛")
   ...
   spawn(function()
     ...
     Events:Toggle("九尾岛透视", false, function(value)
    ...
    Events:Toggle("瞬移至九尾岛", false, function(value)
   ...
   spawn(function()
	...
	spawn(function()
     ...
     Events:Toggle("自动获取苍蓝余烬", false, function(value)
   ...
   spawn(function()
    ...
    Events:Toggle("自动驾驶船", false, function(value)
    _G.SailBoat = value
    _G.Nocliprock = value
...
spawn(function()
    ...
    Events:Toggle("自动击杀恐惧鲨",false, function(state)
...
while wait() do 
 ...
 spawn(function()
    ...
    Events:Toggle("自动击杀鲨鱼",false, function(state)
        _G.KillShark = state
    ...
    Events:Toggle("自动击杀食人鱼",false, function(state)
    ...
    Events:Toggle("自动击杀鱼人海贼团员",false, function(state)
      ...
      spawn(function()
        while wait() do 
         ...
         Events:Seperator("幻影岛")
         
        Mirragecheck = Events:Label("查看幻影岛")
            spawn(function()
        pcall(function()
            while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                    Mirragecheck:Set('幻影岛 已刷新 ✅')
                else
                    Mirragecheck:Set('幻影岛 没刷新❌') 
                 end
            end
        end)
    end)           
    
      Events:Toggle("透视幻影岛", false, function(value)
    ...
    Events:Toggle("瞬移至幻影岛 ",false, function(Value)
    ...
    while task.wait(0.1) do
      ...
      Events:Toggle("观测月亮 + 自动觉醒V3",false, function(Value)
        _G.AutoDooHee = Value
        end)
  local virtualInputManager = game:GetService("VirtualInputManager")
   spawn(function()
    ...
    Events:Toggle("瞬移至齿轮机关",false, function(state)
        _G.TweenMGear = state
    ...
    Events:Button("瞬移至高级果实商人",function()
    TweenNpc()
    end)
  ...
  local Pulllevel = Trailers:Label("查看神庙大门")
  
   task.spawn(function()
    while wait() do
        pcall(function()
            if game.ReplicatedStorage.Remotes.CommF_:InvokeServer("CheckTempleDoor") then
                Pulllevel:Set("拉取等级：已完成 ✅")
            else
                Pulllevel:Set("拉取等级：未完成 ❌")
               end
            end)
          end
       end)
    ...
    Trailers:Button("自动开启种族试炼之门",function()
       ...
       Trailers:Button("购买远古之人任务",function()
       game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
        end)
     
     Trailers:Seperator("种族V4试炼")
           
        Trailers:Toggle("自动觉醒人类",false, function(Value)
        _G.Kill_Aura = Value
        end)
        
        Trailers:Toggle("自动觉醒全种族",false, function(Value)
    ...
    pcall(function()
     ...
     Trailers:Toggle("自动击杀V4玩家",false, function(Value)
...
Trailers:Toggle("Z技能",false, function(Value)
        _G.XaiSkillZ = Value
        end)
Trailers:Toggle("X技能",false, function(Value)
        _G.XaiSkillX = Value
        end)
Trailers:Toggle("C技能",false, function(Value)
        _G.XaiSkillC = Value
        end)        

    Espbruh:Toggle("岛屿透视", false, function(value)
        IslandESP = value
    ...
    spawn(function()
        ...
        Espbruh:Toggle("透视玩家", false, function(value)
        ESPPlayer = value
    ...
    Espbruh:Toggle("透视宝箱", false, function(value)
        _G.ChestESP = value
    ...
    spawn(function()
        ...
        Espbruh:Toggle("透视果实", false, function(value)
        DevilFruitESP = value
    ...
    Espbruh:Toggle("浆果透视", false, function(value)
        Berry = value
        while Berry do wait()
            UpdateBerriesESP()
        end
    ...
    Espbruh:Toggle("果实透视", false, function(value)
        RealFruitESP = value
    ...
    Espbruh:Toggle("齿轮机关透视", false, function(value)
        GearESP = value
    ...
    Espbruh:Toggle("花朵透视", false, function(value)
        FlowerESP = value
    ...
    spawn(function()
       ...
       Espbruh:Toggle("幻影岛透视", false, function(value)
        MirageIslandESP = value
        while MirageIslandESP do wait()
            UpdateIslandMirageESP() 
        end
    ...
    Espbruh:Toggle("史前岛透视", false, function(value)
    ...
    Espbruh:Toggle("九尾岛透视", false, function(value)
        KitsuneIslandEsp = value
        while KitsuneIslandEsp do wait()
            UpdateIslandKisuneESP()   
        end
   ...
   TimeRaid = AutoRaid:Label("自动副本")

   spawn(function()
    pcall(function()
        while wait() do
   if game.Workspace._WorldOrigin.Locations:FindFirstChild('岛屿 5') then
    TimeRaid:Set('状态：岛屿5')
    elseif game.Workspace._WorldOrigin.Locations:FindFirstChild('岛屿 4') then
      TimeRaid:Set('状态：岛屿1')
     elseif game.Workspace._WorldOrigin.Locations:FindFirstChild('岛屿 3') then
      TimeRaid:Set('状态：岛屿3')
     elseif game.Workspace._WorldOrigin.Locations:FindFirstChild('岛屿 2') then
      TimeRaid:Set('状态：岛屿2')
      elseif game.Workspace._WorldOrigin.Locations:FindFirstChild('岛屿 1') then
        TimeRaid:Set('状态：岛屿1')
        else
         TimeRaid:Set("状态：开始地牢") 
         end
        end
     end)
   end)        
    
    AutoRaid:Dropdown("选择副本",{"火焰","寒冰","沙暴","暗影","光明","熔岩","地震","佛陀","蜘蛛","凤凰","雷霆","面团"},{"火焰"},function(v)
    SelectChip = v
     end)
    
    AutoRaid:Toggle("自动购买芯片", false, function(value)
   ...
   AutoRaid:Toggle("自动开始突袭", false, function(value)
    _G.StartRaid = value
    end)
...
spawn(function()
   ...
   AutoRaid:Toggle("自动刷取下一岛屿的突袭", false, function(value)
    _G.Dungeon = value
...
spawn(function()
   ...
   AutoRaid:Toggle("觉醒果实", false, function(value)
  ...
  spawn(function()
    ...
    AutoRaid:Toggle("自动低价收购果实", false, function(value)
    _G.Autofruit = value
    end)
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
      ...
      if World2 then
     AutoRaid:Seperator("自动突袭")
     
     Events:Button("自动购买芯片",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    Events:Button("自动突袭",function()
    fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
    end)
     
     AutoRaid:Toggle("自动刷突袭", false, function(value)
  ...
  local FindFruit = Autofruit:Label("检测果实")
...
spawn(function()
  ...
  Autofruit:Toggle("自动随机吃果实", false, function(value)
    _G.RandomAuto = value
    end)
...
spawn(function()
   ...
   Autofruit:Button("随机果实",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
    end)
   
   Autofruit:Toggle("自动囤积果实", false, function(value)
   ...
   Autofruit:Toggle("自动传送果实", false, function(value)
    _G.TweenFruit = value
    end)
        spawn(function()
		while wait(.1) do
    ...
    Autofruit:Toggle("自动抢夺果实", false, function(value)
    _G.Grabfruit = value
    end)
    spawn(function()
    while wait(.1) do
   ...
   Autofruit:Button("自动抢夺全图果实",function()
           for i,v in pairs(game.Workspace:GetChildren()) do
            if v:IsA("Tool") then
     ...
     Teleport:Button("传送至第一海域",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    Teleport:Button("传送至第二海域",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    Teleport:Button("传送至第三海域",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    Teleport:Seperator("传送岛")
    
    if World1 then
   Teleport:Dropdown("选择岛屿",{"风车村","海军基地","中镇","丛林","海盗村","沙漠","雪岛","海军总部","竞技场","空岛1层","空岛2层","空岛3层","监狱","熔岩村","海底岛","喷泉城","香克斯房间","野怪岛"},{"风车村"},function(value)
    _G.SelectIsland = value
     end)
     end
     
    if World2 then
   Teleport:Dropdown("选择岛屿",{"咖啡馆","第一地点","暗黑区域","火烈鸟庄园","火烈鸟房间","绿色地带","工厂","竞技场","僵尸岛","双雪山","庞克禁区","诅咒之船","冰城堡","遗忘之岛","乌索普岛","迷你空岛"},{"咖啡馆"},function(value)
    _G.SelectIsland = value
     end)
     end
     
    if World3 then
   Teleport:Dropdown("选择岛屿",{"庄园","港口镇","巨树","海上城堡","迷你空岛","海蛇岛","浮空龟岛","幽灵城堡","冰淇淋岛","花生岛","蛋糕岛","可可岛","糖果岛","图腾前哨站"},{"庄园"},function(value)
    _G.SelectIsland = value
     end)
     end     
     
  Teleport:Toggle("自动传送至岛屿", false, function(value)
      ...
      Teleport:Seperator("自动传送NPC")    
       
     if World1 then
   Teleport:Dropdown("选择NPC",{"随机恶魔果实","布鲁克斯水果商人","移除恶魔果实","技能导师","暗步","雷电","鱼人空手道"},{"随机恶魔果实"},function(value)
    _G.SelectNPC = value
     end)
     end
     
     if World2 then
   Teleport:Dropdown("选择NPC",{"龙之呼吸","神秘人","神秘科学家","觉醒专家","书呆子","酒吧经理","布鲁克斯水果商人","特雷弗","强化编辑","海盗招募官","海军招募官","化学家","改造人","食尸鬼印记","瓜希姆","管理员","罗道夫","阿罗威"},{"龙之呼吸"},function(value)
    _G.SelectNPC = value
     end)
     end
     
      if World3 then
   Teleport:Dropdown("选择NPC",{"布鲁克斯水果商人","移除恶魔果实","角人","饥饿者","前任英雄","管家","卢诺文","特雷弗","精英猎人","玩家猎人","乌佐斯"},{"随机恶魔果实"},function(value)
    _G.SelectNPC = value
     end)
     end     
     
     Teleport:Toggle("自动传送NPC", false, function(value)
    ...
    AutoPlayers = Playersss:Label("检测玩家")
        ...
        while wait() do
            pcall(function()
                for i,v in pairs(game:GetService("Players"):GetPlayers()) do
                    if i == 12 then
                        AutoPlayers:Set("玩家 :".." "..i.." ".."/".." ".."12".." ".."(Max)")
                    elseif i == 1 then
                        AutoPlayers:Set("玩家 :".." "..i.." ".."/".." ".."12")
                    else
                        AutoPlayers:Set("玩家 :".." "..i.." ".."/".." ".."12")
                    end
                end
    ...
    local SelectedPly = Playersss:Dropdown("选择玩家",Playerslist,false,function(value)
        _G.SelectPly = value
    end)
    
      Playersss:Button("刷新玩家列表",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
        ...
        Playersss:Toggle("观战玩家", false, function(v)
    	SpectatePlys = v
    ...
    Playersss:Toggle("传送到玩家旁", false, function(value)
    ...
    Playersss:Toggle("自动杀死玩家", false, function(value)
    ...
    Playersss:Seperator("追踪玩家任务")
    
    Playersss:Button("获取精英玩家任务",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
    end)
    
    Playersss:Toggle("自动击杀任务玩家", false, function(Killzps)
    ...
    Playersss:Toggle("自瞄", false, function(value)
        _G.Aimbot_Gun = value
    end)
    ...
    Playersss:Toggle("最近目标技能自瞄", false, function(MakoriGG)
...
spawn(function()
    ...
    Playersss:Toggle("技能自瞄", false, function(value)
    ...
    Playersss:Toggle("开启PvP", false, function(value)
        _G.EnabledPvP = value
    end)
    ...
    Playersss:Toggle("安全模式", false, function(value)
        _G.SafeMode = value
    ...
    Playersss:Button("自动重生",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
        wait()
    end)
    
        TikTokShop:Seperator("技能栏")
    
   TikTokShop:Button("购买月步（$10,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    end)
    
   TikTokShop:Button("购买武装色霸气（$25,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    end)
    
   TikTokShop:Button("购买剃步（$25,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
    
   TikTokShop:Button("购买见闻色霸气（$750,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
    
   TikTokShop:Toggle("自动购买技能", false, function(t)
    Abilities = t
...
TikTokShop:Dropdown("选择船只",BoatList,false,function(value)
    SelectBoat = value
end)

TikTokShop:Button("购买船只",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBoat",_G.SelectBoat)
end)

    TikTokShop:Seperator("战斗风格")
    
   TikTokShop:Button("购买黑足格斗（$150,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    end)
    
   TikTokShop:Button("购买雷电格斗（$550,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
    end)
    
   TikTokShop:Button("购买鱼人空手道（$750,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    end)
    
   TikTokShop:Button("购买龙爪拳（1,500碎片）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    end)
    
   TikTokShop:Button("购买超人拳（$3,000,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    end)
    
   TikTokShop:Button("购买死亡步法（$5,000,000 + 5,000碎片）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
   TikTokShop:Button("购买鲨鱼人空手道（$2,500,000 + 5,000碎片）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
   TikTokShop:Button("购买电击爪（$3,000,000 + 5,000碎片）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
   TikTokShop:Button("购买龙爪（$3,000,000 + 5,000碎片）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)

   TikTokShop:Button("购买神人（$5,000,000 + 5,000碎片）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end)

   TikTokShop:Button("购买血族秘术（$5,000,000 + 5,000F）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySanguineArt", true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySanguineArt")
    end)

    TikTokShop:Seperator("剑")
    
   TikTokShop:Button("弯刀（$1,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
    end)

   TikTokShop:Button("武士刀（$1,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
    end)
    
   TikTokShop:Button("铁狼牙棒（$25,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
    end)
    
   TikTokShop:Button("双武士刀（$12,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
    end)
    
   TikTokShop:Button("三刀流（$60,000）", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
    end)
    
   TikTokShop:Button("水管（$100,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
    end)
    
   TikTokShop:Button("双刃战斧（$400,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
    end)
    
   TikTokShop:Button("长柄薙刀（$1,200,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
    end)
    
   TikTokShop:Button("魂灵手杖（$750,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
    end)

   TikTokShop:Button("极寒长枪（5,000F）",function()
		game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ThunderGodTalk")
	end)

    TikTokShop:Seperator("枪")
    
   TikTokShop:Button("弹弓（$5,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Slingshot")
    end)
    
   TikTokShop:Button("火绳枪（$8,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Musket")
    end)
    
   TikTokShop:Button("燧发枪（$10,500）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Flintlock")
    end)
    
   TikTokShop:Button("精制弹弓（$30,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
    end)
    
   TikTokShop:Button("精制燧发枪（$65,000）",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Refined Flintlock"
		}
   ...
   TikTokShop:Button("火炮（$100,000）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cannon")
    end)
    
   TikTokShop:Button("南瓜炮（1,500F）",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","2")
    end)

      TikTokShop:Button("诡谲步枪（250灵质）", function()
         local A_1 = "Ectoplasm"
        local A_2 = "Buy"
        local A_3 = 1
    ...
    TikTokShop:Seperator("属性")

TikTokShop:Button("重置属性（2,500F）", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

TikTokShop:Button("随机种族（3,000F）", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end)

    TikTokShop:Seperator("饰品")
	TikTokShop:Button("黑斗篷（$50,000）",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Black Cape"
		}
	...
	TikTokShop:Button("剑士之帽（$150,000）",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Swordsman Hat"
		}
	...
	TikTokShop:Button("巴纹戒指（$500,000）",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Tomoe Ring"
		}
        ...
        AutoMisc:Seperator("杂项")
    
    AutoMisc:Button("开启霸气色", function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
    end)

    AutoMisc:Button("解锁称号", function()
        local args = {
            [1] = "getTitles"
        }
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
    ...
    AutoMisc:Button("打开背包",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")
        wait(1)
        game:GetService("Players").LocalPlayer.PlayerGui.Main.Inventory.Visible = true
    end)
    
    AutoMisc:Button("打开果实背包",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true
    end)
    
      
AutoMisc:Seperator("团队")
    
    AutoMisc:Button("加入海盗阵营",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    AutoMisc:Button("加入海军阵营",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
    end)
    
AutoMisc:Seperator("高亮显示")

AutoMisc:Toggle("隐藏聊天",false,function(value)
    _G.chat = value
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  AutoMisc:Toggle("隐藏排行榜",false,function(a)
    _G.leaderboard = a
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    AutoMisc:Toggle("高亮模式",false,function(value)
        if value == true then
    ...
    AutoMisc:Button("一键兑换全部兑换码",function()
    ...
    AutoMisc:Dropdown("选择兑换码",{"NOOB_REFUND","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},false,function(value)
        _G.CodeSelect = value
    end)
    
    AutoMisc:Button("兑换兑换码",function()
        game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.CodeSelect)
    end)
    
    AutoMisc:Seperator("画面设置")

    
    AutoMisc:Button("帧率优化",function()
...
AutoMisc:Button("移除迷雾",function()
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
	game.Lighting.FogEnd = 9e9
end)

AutoMisc:Button("移除岩浆",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
    ...
    AutoMisc:Button("重新加入服务器",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
    AutoMisc:Button("快速切换服务器",function()
        while wait() do
        ...
        Status:Seperator("属性面板")

  local Pointstat = Status:Label("属性点数")
    
    spawn(function()
        while wait() do
            pcall(function()
                Pointstat:Set("属性点数s : "..tostring(game:GetService("Players")["LocalPlayer"].Data.Points.Value))
            end)
        end
    end)
    
local Melee = Status:Label("近战 : ")
local Defense = Status:Label("近战 : ")
local Sword = Status:Label("剑 : ")
local Gun = Status:Label("枪 : ")
local Fruit = Status:Label("果实 : ")
...
Status:Toggle("近战", false, function(value)
melee = Value    
end)
Status:Toggle("近战", false, function(value)
defense = value
end)
Status:Toggle("剑", false, function(value)
sword = value
end)
Status:Toggle("枪", false, function(value)
gun = value
end)
Status:Toggle("恶魔果实", false, function(value)
demonfruit = value
end)
...
Time:Set("[执行耗时]：小时："..Hour.." 分钟："..Minute.." 秒："..Second)
end
...
UpdateClient1()
        ...
        MiragaCheck = StatusTime:Label("检测幻影岛")
            spawn(function()
        pcall(function()
            while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                    MiragaCheck:Set('幻影岛 已诞生 ✅')
                else
                    MiragaCheck:Set('幻影岛 未诞生 ❌') 
                 end
            end
        end)
    end)           
    
    PrehistoricCheck = StatusTime:Label("检测火山岛")
  
  spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                PrehistoricCheck:Set("火山岛 已诞生 ✅")
            else
                PrehistoricCheck:Set("火山岛 未诞生 ❌")
               end
            end)
          end
       end)
       
       KitsuneCheck = StatusTime:Label("检测九尾岛")
   
   spawn(function()
        pcall(function()
            while wait() do
         if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
      KitsuneCheck:Set('九尾岛 已诞生 ✅')
        else
      KitsuneCheck:Set('九尾岛 未诞生 ❌' )
            end
            end
         end)
     end)
